...
test("the route inventory is exact and every control operation fails closed", async () => {
  ...
  const expectedPaths = [
    ...
    "/onboarding/agent-connections/{connectionId}",
    "/onboarding/projects",
    "/onboarding/projects/{projectId}/repository",
    "/onboarding/projects/{projectId}/selection",
    "/openapi.json",
    "/principal-invitations",
    "/principal-invitations/{id}",
    "/principals",
    "/projects",
    "/projects/{projectId}",
    "/projects/{projectId}/annotations",
    "/projects/{projectId}/annotations/{annotationId}/resolve",
    "/projects/{projectId}/members",
    "/projects/{projectId}/members/{principalId}",
    "/projects/{projectId}/participants",
    "/projects/{projectId}/presence",
    "/projects/{projectId}/presence/{clientId}",
    "/projects/{projectId}/recent-relays",
    "/projects/{projectId}/relay-inbox",
